...
arbtt-capture-wl runs continuously in the background and reads your window
titles, so I'd rather hear about a problem than not. Thanks for taking the time
to look.
...
- any logs or config (with sensitive data redacted) that help me confirm it
...
The arbtt-capture-wl codebase in this repository is in scope. Issues in
third-party dependencies are better reported upstream, though I do want to hear
about it if a dependency issue is exploitable through how this tool uses it.
